...
`{{ var.value.storage_project_id }}.{{ dag_run.conf['site_name'] }}.{{ params['visits_per_sq_ft_state_table'] }}` as
...
select * from `{{ var.value.storage_project_id }}.{{ dag_run.conf['site_name'] }}.{{ params['chain_ranking_state_table'] }}`
