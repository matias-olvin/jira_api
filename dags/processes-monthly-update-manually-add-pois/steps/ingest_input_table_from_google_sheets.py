...
def register(
    ...
    with TaskGroup(
        ...
        create_snapshot_of_input_table = OlvinBigQueryOperator(
            ...
            query="{% include './include/bigquery/ingest_input_table_from_google_sheets/create_snapshot_of_input_table.sql' %}",
        )
        ...
        load_input_table_to_bigquery_from_gcs = OlvinBigQueryOperator(
            ...
            query="{% include './include/bigquery/ingest_input_table_from_google_sheets/load_input_table_to_bigquery_from_gcs.sql' %}",
        )

        check_duplicates_in_input_info_table = OlvinBigQueryOperator(
            task_id="check_duplicates_in_input_info_table",
            query="{% include './include/bigquery/ingest_input_table_from_google_sheets/input_info_checks/check_duplicates_in_input_info_table.sql' %}",
        )

        check_nulls_fk_sgplaces = OlvinBigQueryOperator(
            task_id="check_nulls_fk_sgplaces",
            query="{% include './include/bigquery/ingest_input_table_from_google_sheets/input_info_checks/check_nulls_fk_sgplaces.sql' %}",
        )

        check_nulls_city_postal_code_polygon = OlvinBigQueryOperator(
            task_id="check_nulls_city_postal_code_polygon",
            query="{% include './include/bigquery/ingest_input_table_from_google_sheets/input_info_checks/check_nulls_city_postal_code_polygon.sql' %}",
        )

        check_unique_fk_sgbrands_per_brand = OlvinBigQueryOperator(
            task_id="check_unique_fk_sgbrands_per_brand",
            query="{% include './include/bigquery/ingest_input_table_from_google_sheets/input_info_checks/check_unique_fk_sgbrands_per_brand.sql' %}",
        )

        check_lat_lon_coords_with_region = OlvinBigQueryOperator(
            task_id="check_lat_lon_coords_with_region",
            query="{% include './include/bigquery/ingest_input_table_from_google_sheets/input_info_checks/check_lat_lon_coords_with_region.sql' %}",
        )

        verify_intended_region = OlvinBigQueryOperator(
            task_id="verify_intended_region",
            query="{% include './include/bigquery/ingest_input_table_from_google_sheets/input_info_checks/verify_intended_region.sql' %}",
        )
