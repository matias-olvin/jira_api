CREATE OR REPLACE TABLE `{{ var.value.env_project }}.{{ params['smc_demand_dataset'] }}.{{ params['metrics_dataset'] }}_{{ params['day_stats_visits_scaled_table'] }}`
LIKE `{{ var.value.env_project }}.{{ params['metrics_dataset'] }}.{{ params['day_stats_visits_scaled_table'] }}`;

CREATE OR REPLACE TABLE `{{ var.value.env_project }}.{{ params['smc_demand_dataset'] }}.{{ params['day_stats_visits_scaled_table'] }}`
...
FROM
`{{ var.value.env_project }}.{{ params['smc_demand_dataset'] }}.{{ params['day_stats_visits_scaled_table'] }}`;