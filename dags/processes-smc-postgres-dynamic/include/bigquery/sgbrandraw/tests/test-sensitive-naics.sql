...
) = 0 AS "Error: NAICS codes in {{ params['smc_postgres_dataset'] }}.{{ params['sgbrandraw_table'] }} do not match those in {{ params['sg_base_tables_dataset'] }}.{{ params['non_sensitive_naics_codes_table'] }}"
