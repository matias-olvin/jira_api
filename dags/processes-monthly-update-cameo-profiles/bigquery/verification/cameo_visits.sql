CREATE OR REPLACE TABLE `{{ var.value.env_project }}.{{ params['cameo_staging_dataset'] }}.{{ params['cameo_visits_table'] }}_check` AS
...
SELECT
*
FROM `{{ var.value.env_project }}.{{ params['cameo_staging_dataset'] }}.{{ params['cameo_visits_table'] }}_check`
 WHERE
