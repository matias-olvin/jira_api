...
def register(start: Union[TaskInstance, TaskGroup], dag: DAG) -> TaskGroup:
    ...
    Returns:
        airflow.utils.task_group.TaskGroup: The type-2 finance task group.
    """
    ...
    with TaskGroup(group_id="general-type2") as general_type2:
        ...
        schema = "public_data_feeds_type_2"
        ...
        refresh_snowflake_placekeys = SnowflakeOperator(
            ...
            sql=f"ALTER STAGE {database}.{schema}.ext_stage_type2_general_placekeys REFRESH ;",
            snowflake_conn_id="snowflake_conn",
            schema=schema,
        )
  ...
  FROM @ext_stage_type2_general_placekeys
  ...
  PATTERN='.*[.]parquet';""",
        ...
        refresh_snowflake_store_visitors = SnowflakeOperator(
            ...
            sql=f"ALTER STAGE {database}.{schema}.ext_stage_type2_general_store_visitors REFRESH ;",
            snowflake_conn_id="snowflake_conn",
            schema=schema,
        )
  ...
  FROM @ext_stage_type2_general_store_visitors
  FILE_FORMAT = (TYPE = 'PARQUET')
  MATCH_BY_COLUMN_NAME='CASE_INSENSITIVE'
  PATTERN='.*[.]parquet';""",
            snowflake_conn_id="snowflake_conn",
        ...
        refresh_snowflake_store_visits_trend = SnowflakeOperator(
            ...
            sql=f"ALTER STAGE {database}.{schema}.ext_stage_type2_general_store_visits_trend REFRESH ;",
            snowflake_conn_id="snowflake_conn",
            schema=schema,
        )
  ...
  FROM @ext_stage_type2_general_store_visits_trend
  FILE_FORMAT = (TYPE = 'PARQUET')
  MATCH_BY_COLUMN_NAME='CASE_INSENSITIVE'
  PATTERN='.*[.]parquet';""",
            snowflake_conn_id="snowflake_conn",
        ...
        refresh_snowflake_store_visits = SnowflakeOperator(
            ...
            sql=f"ALTER STAGE {database}.{schema}.ext_stage_type2_general_store_visits REFRESH ;",
            snowflake_conn_id="snowflake_conn",
            schema=schema,
        )
  ...
  FROM @ext_stage_type2_general_store_visits
  FILE_FORMAT = (TYPE = 'PARQUET')
  MATCH_BY_COLUMN_NAME='CASE_INSENSITIVE'
  PATTERN='.*[.]parquet';""",
            snowflake_conn_id="snowflake_conn",
    ...
    with TaskGroup(group_id="finance-type2") as finance_type2:
        ...
        schema = "public_data_feeds_type_2_finance"
        ...
        refresh_snowflake_placekeys = SnowflakeOperator(
            database=database,
            task_id="refresh_snowflake_placekeys",
            sql=f"ALTER STAGE {database}.{schema}.ext_stage_type2_finance_placekeys REFRESH ;",
            snowflake_conn_id="snowflake_conn",
            schema=schema,
        )
        ...
        copy_snowflake_placekeys = SnowflakeOperator(
            ...
            task_id="copy_snowflake_placekeys",
            sql=f"""USE WAREHOUSE {warehouse}; COPY INTO {database}.{schema}.placekeys
  FROM @ext_stage_type2_finance_placekeys
  FILE_FORMAT = (TYPE = 'PARQUET')
  MATCH_BY_COLUMN_NAME='CASE_INSENSITIVE'
  PATTERN='.*[.]parquet';""",
            snowflake_conn_id="snowflake_conn",
        ...
        refresh_snowflake_store_visitors = SnowflakeOperator(
            database=database,
            task_id="refresh_snowflake_store_visitors",
            sql=f"ALTER STAGE {database}.{schema}.ext_stage_type2_finance_store_visitors REFRESH ;",
            snowflake_conn_id="snowflake_conn",
            schema=schema,
        )
        ...
        copy_snowflake_store_visitors = SnowflakeOperator(
            ...
            task_id="copy_snowflake_store_visitors",
            sql=f"""USE WAREHOUSE {warehouse}; COPY INTO {database}.{schema}.store_visitors
  FROM @ext_stage_type2_finance_store_visitors
  FILE_FORMAT = (TYPE = 'PARQUET')
  MATCH_BY_COLUMN_NAME='CASE_INSENSITIVE'
  PATTERN='.*[.]parquet';""",
            snowflake_conn_id="snowflake_conn",
        ...
        refresh_snowflake_store_visits_trend = SnowflakeOperator(
            database=database,
            task_id="refresh_snowflake_store_visits_trend",
            sql=f"ALTER STAGE {database}.{schema}.ext_stage_type2_finance_store_visits_trend REFRESH ;",
            snowflake_conn_id="snowflake_conn",
            schema=schema,
        )
        ...
        copy_snowflake_store_visits_trend = SnowflakeOperator(
            ...
            task_id="copy_snowflake_store_visits_trend",
            sql=f"""USE WAREHOUSE {warehouse}; COPY INTO {database}.{schema}.store_visits_trend
  FROM @ext_stage_type2_finance_store_visits_trend
  FILE_FORMAT = (TYPE = 'PARQUET')
  MATCH_BY_COLUMN_NAME='CASE_INSENSITIVE'
  PATTERN='.*[.]parquet';""",
            snowflake_conn_id="snowflake_conn",
        ...
        refresh_snowflake_store_visits = SnowflakeOperator(
            database=database,
            task_id="refresh_snowflake_store_visits",
            sql=f"ALTER STAGE {database}.{schema}.ext_stage_type2_finance_store_visits REFRESH ;",
            snowflake_conn_id="snowflake_conn",
            schema=schema,
        )
        ...
        copy_snowflake_store_visits = SnowflakeOperator(
            ...
            task_id="copy_snowflake_store_visits",
            sql=f"""USE WAREHOUSE {warehouse}; COPY INTO {database}.{schema}.store_visits
  FROM @ext_stage_type2_finance_store_visits
  FILE_FORMAT = (TYPE = 'PARQUET')
  MATCH_BY_COLUMN_NAME='CASE_INSENSITIVE'
  PATTERN='.*[.]parquet';""",
            snowflake_conn_id="snowflake_conn",
    ...
    start >> sensor >> general_type2 >> finance_type2

    return finance_type2
